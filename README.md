...
- Associate Pastor focused on teaching and discipleship  
...
- **Barcode & Labeling Tools**  
  Scripts and automation workflows for Zebra scanners and inventory management.
...
### ✝️ **Ministry Projects**
- **Sermon Builder App**  
  AI-powered sermon and Bible study generator with exportable outlines.

- **Bible Study Toolkit**  
  Tools for cross-references, themes, and devotional structure.

- **Pastoral Resource Hub**  
  An upcoming platform to support pastors in growth, organization, and spiritual health.
